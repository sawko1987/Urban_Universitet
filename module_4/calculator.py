...
button_add = tk.Button(window, text = '+', width= 2, heigh=2, command=add)
button_add.place(x=100, y=200)

button_sub = tk.Button(window, text = '-', width=2, height= 2, command=sub)
button_sub.place(x=150, y=200)

button_mul = tk.Button(window, text = 'x', width= 2, heigh=2, command=mul)
button_mul.place(x=200, y=200)

button_div = tk.Button(window, text = '/', width= 2, heigh=2, command = div)
...
number3.place(x=100, y=300)


window.mainloop()  # цикл обновления на экране
